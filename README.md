...
6. **右键（或按住 Control 点击）FocusGuard → 选择「打开」**
7. 弹出对话框提示「无法验证开发者」，点击「**打开**」按钮

> 这是 macOS Gatekeeper 对未签名 App 的正常拦截，**只需右键打开一次**，之后就可以双击打开了。
...
这说明 DMG 下载过程中文件损坏或被篡改，请重新下载。如果确认下载无误，终端运行：
