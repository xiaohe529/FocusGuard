...
- **GitHub**: [Releases](https://github.com/xiaohe529/FocusGuard/releases)
- **Gitee（国内更快）**: [Releases](https://gitee.com/xiaohe529/FocusGuard/releases)

下载最新版 `FocusGuard.dmg`，双击打开后拖入 `Applications` 文件夹。
...
# 或国内镜像
git clone https://gitee.com/xiaohe529/FocusGuard.git
cd FocusGuard
